...
class CheckResponse
{
     ...
     * OK
     *
     * @var ?Shared\CreateCheckResponse $createCheckResponse
     */
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Shared\CreateCheckResponse $createCheckResponse = null)
    {
