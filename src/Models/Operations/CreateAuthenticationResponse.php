...
class CreateAuthenticationResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Shared\CreateAuthenticationResponse $createAuthenticationResponse = null)
    {
